					...
					<div class="susuntombol" style="text-align:center!important;">
						<button onclick="location.href='<?= $base_url ?>/user/cekkartu/1';" class="btn btn-lg btn-warning tmbl-menu">
							<p class="tombol-l1">KARIS</p>
							<p class="tombol-l2">Kartu Istri</p>
						</button>
						<button onclick="location.href='<?= $base_url ?>/user/cekkartu/2';" class="btn btn-lg btn-warning tmbl-menu">
							<p class="tombol-l1">KARSU</p>
							<p class="tombol-l2">Kartu Suami</p>
						</button>
						<button onclick="location.href='<?= $base_url ?>/user/cekkartu/3';" class="btn btn-lg btn-warning tmbl-menu">
